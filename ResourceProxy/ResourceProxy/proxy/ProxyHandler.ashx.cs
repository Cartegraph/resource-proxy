...
{
    public class ProxyHandler : HttpTaskAsyncHandler, IReadOnlySessionState
    {
        ...
        public override async Task ProcessRequestAsync(HttpContext context)
        {
            ...
            if (uri.Equals("ping", StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                await sendPingResponse(response, version, checkConfig, checkLog);
                return;
            }
...
*/
        ...
        private static async Task sendPingResponse(HttpResponse response, String version, String config, String log)
        {
